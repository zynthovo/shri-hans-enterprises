...
export const metadata: Metadata = { title: "Contact - Zynthovo Digital" };
...
export default async function ContactPage() {
  ...
  const info = [
    ...
    { icon: "bi-telephone", title: "Call Us", text: `+91 ${contact.phone}` },
    {
      icon: "bi-envelope",
      title: "Email Us",
        ...
        <div className="site-container px-4 sm:px-0">
          <Reveal animation="fade-up" className="mb-8 overflow-hidden rounded-2xl">
            <iframe
              ...
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d228077!2d80.94!3d26.84!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0!2sLucknow!5e0!3m2!1sen!2sin!4v1700000000000"
              loading="lazy"
          ...
          <div className="grid gap-6 lg:grid-cols-12">
            <Reveal stagger={0.12} className="space-y-4 lg:col-span-4">
              {info.map((i) => (
                <div
                  key={i.title}
                  className="flex gap-4 rounded-2xl bg-surface p-6 shadow-[0_10px_30px_rgba(0,25,70,0.06)]"
                >
              ...
              <a
                href={`https://wa.me/${contact.whatsapp}?text=${encodeURIComponent(
                  "Hi Zynthovo! I'd like to know more about your services."
                )}`}
                target="_blank"
            ...
            <Reveal animation="fade-up" className="lg:col-span-8">
              <ContactForm
                fields={[
                  ...
                  { name: "subject", placeholder: "Subject", full: true },
                  { name: "message", placeholder: "Message", textarea: true },
                ]}
                button="Send Message"
                subject="New contact message from the Zynthovo website"
